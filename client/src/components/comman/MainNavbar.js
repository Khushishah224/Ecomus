...
const Popup = ({ show, onClose }) => {
  const [currentForm, setCurrentForm] = useState('register'); // State to track the current form
          ...
          <>
            ...
            <form>
              ...
              <div className="form-content d-flex justify-content-between">
                ...
                <div className="text-div text-decoration-underline fw-semibold mt-2 pt-1">
                  <p>
